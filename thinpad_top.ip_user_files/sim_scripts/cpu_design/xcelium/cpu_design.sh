...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.cpu_design \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../thinpad_top.srcs/sources_1/bd/cpu_design/ipshared/c923" \
       +incdir+"$ref_dir/../../../../thinpad_top.srcs/sources_1/bd/cpu_design/ipshared/ec67/hdl" \
       +incdir+"../../../../thinpad_top.srcs/sources_1/bd/cpu_design/ipshared/c923" \
       +incdir+"../../../../thinpad_top.srcs/sources_1/bd/cpu_design/ipshared/ec67/hdl"
}
