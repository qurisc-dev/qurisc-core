...
#
# Generated by Vivado on Wed Jul 17 23:45:42 +0800 2019
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cpu_design xil_defaultlib.cpu_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cpu_design -key {Behavioral:sim_2:Functional:cpu_design} -tclbatch cmd.tcl -protoinst "protoinst_files/cpu_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cpu_design.wdb xsim.dir)
