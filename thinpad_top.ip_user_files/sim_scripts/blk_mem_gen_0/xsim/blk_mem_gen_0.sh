...
#
# Generated by Vivado on Wed Jul 17 23:52:41 +0800 2019
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_2:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/cpu_design.protoinst" -log simulate.log
}
