...
architecture STRUCTURE of cpu_design_thinpad_sram_0_0_sram_burster is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[0]_i_5\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of bidir_i_3 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of bidir_i_4 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \burst[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \burst[1]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \curr_addr[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \curr_addr[22]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of last_is_last_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \len[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \len[3]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \len[5]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \orig_len[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \orig_len[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \orig_len[7]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \size[1]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \stored_be[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \stored_be[5]_i_1\ : label is "soft_lutpair6";
begin
...
\stored_id[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of cpu_design_thinpad_sram_0_0_thinpad_sram_v1_0_S00_AXI is
  ...
  signal get_addr_n_44 : STD_LOGIC;
  signal get_addr_n_45 : STD_LOGIC;
  signal \^last_is_last_reg_0\ : STD_LOGIC;
  signal \last_read_data[63]_i_1_n_0\ : STD_LOGIC;
  signal rst : STD_LOGIC;
  signal \^s00_axi_bvalid\ : STD_LOGIC;
  signal \^s00_axi_rid\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal \stored_id[0]_i_1_n_0\ : STD_LOGIC;
  signal \stored_id[1]_i_1_n_0\ : STD_LOGIC;
  signal \stored_id[2]_i_1_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
...
get_addr: entity work.cpu_design_thinpad_sram_0_0_sram_burster
     port map (
      ...
      \FSM_sequential_state_reg[1]\ => get_addr_n_33,
      \FSM_sequential_state_reg[1]_0\ => get_addr_n_38,
      \FSM_sequential_state_reg[1]_1\ => get_addr_n_43,
      \FSM_sequential_state_reg[1]_2\ => get_addr_n_44,
      ...
      s00_axi_aresetn_0 => get_addr_n_35,
      ...
      \sram_state_reg[0]\ => get_addr_n_36,
      \sram_state_reg[0]_0\ => get_addr_n_42,
      \sram_state_reg[0]_1\ => \sram_state[2]_i_6_n_0\,
      \sram_state_reg[0]_2\ => \sram_state_reg_n_0_[1]\,
      \sram_state_reg[1]\ => get_addr_n_39,
      \sram_state_reg[1]_0\ => \^last_is_last_reg_0\,
      \sram_state_reg[2]\ => get_addr_n_37,
      \sram_state_reg[2]_0\ => get_addr_n_40,
      \sram_state_reg[2]_1\ => get_addr_n_45,
      start_read => start_read,
...
\stored_id[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8FFB800"
    )
        port map (
      ...
      I3 => get_addr_n_35,
      I4 => \^s00_axi_rid\(0),
      O => \stored_id[0]_i_1_n_0\
    );
\stored_id[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8FFB800"
    )
        port map (
      ...
      I3 => get_addr_n_35,
      I4 => \^s00_axi_rid\(1),
      O => \stored_id[1]_i_1_n_0\
    );
\stored_id[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8FFB800"
    )
        port map (
      ...
      I3 => get_addr_n_35,
      I4 => \^s00_axi_rid\(2),
      O => \stored_id[2]_i_1_n_0\
    );
\stored_id_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \stored_id[0]_i_1_n_0\,
      Q => \^s00_axi_rid\(0),
      R => '0'
    );
\stored_id_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \stored_id[1]_i_1_n_0\,
      Q => \^s00_axi_rid\(1),
      R => '0'
    );
\stored_id_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \stored_id[2]_i_1_n_0\,
      Q => \^s00_axi_rid\(2),
      R => '0'
    );
end STRUCTURE;
...
begin
  s00_axi_bid(2 downto 0) <= \^s00_axi_rid\(2 downto 0);
