...
#
# Generated by export_simulation on Fri Jul 19 20:36:59 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './cache_tag_store.sh' script.

./cache_tag_store.sh -reset_run
...
./cache_tag_store.sh -noclean_files

For more information on the script, please type './cache_tag_store.sh -help'.
