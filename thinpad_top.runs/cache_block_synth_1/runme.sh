...
HD_PWD='C:/Users/gjz010/Documents/GitHub/thinpad_top/thinpad_top.runs/cache_block_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cache_block.tcl
