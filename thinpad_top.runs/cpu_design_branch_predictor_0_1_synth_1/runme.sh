...
HD_PWD='C:/Users/gjz010/Documents/GitHub/thinpad_top/thinpad_top.runs/cpu_design_branch_predictor_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_design_branch_predictor_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_design_branch_predictor_0_1.tcl
