...
# module references:
# dispatcher, l1_cache, loadstore_functionunit, loadstoreunit, registers, renamebuffer, reservestation, rob, branch_predictor, if_controller, if_insn_queue, if_memory_accessor, if_tlb_fetcher, jump_predictor, pc_counter
...
proc create_hier_cell_CPUFrontEnd { parentCell nameHier } {
  ...
  connect_bd_net -net if_insn_queue_0_decoding_pc [get_bd_pins if_insn_queue_0/decoding_pc] [get_bd_pins jump_predictor_0/ras_push_item]
...
proc create_hier_cell_CPUBackEnd { parentCell nameHier } {
  ...
  connect_bd_net -net clk_0_1 [get_bd_pins clk] [get_bd_pins axi_simple_master_0/m00_axi_aclk] [get_bd_pins l1_cache_0/clk] [get_bd_pins loadstore_functionun_0/clk] [get_bd_pins loadstoreunit_0/clk] [get_bd_pins registers_0/clk] [get_bd_pins renamebuffer_0/clk] [get_bd_pins reservestation_0/clk] [get_bd_pins rob_0/clk]
  connect_bd_net -net dispatcher_0_can_dispatch [get_bd_pins dispatcher_0/can_dispatch] [get_bd_pins loadstoreunit_0/store_queue_push] [get_bd_pins renamebuffer_0/do_rename] [get_bd_pins reservestation_0/try_reserve] [get_bd_pins rob_0/push]
  ...
  connect_bd_net -net l1_cache_0_wready [get_bd_pins l1_cache_0/wready] [get_bd_pins rob_0/can_commit_storequeue]
  connect_bd_net -net loadstore_functionun_0_dout [get_bd_pins loadstore_functionun_0/dout] [get_bd_pins reservestation_0/lsu_dout]
  ...
  connect_bd_net -net loadstoreunit_0_store_queue_available [get_bd_pins dispatcher_0/store_queue_ready] [get_bd_pins loadstoreunit_0/store_queue_available]
  ...
  connect_bd_net -net renamebuffer_0_query_line_rs [get_bd_pins renamebuffer_0/query_line_rs] [get_bd_pins rob_0/search_line_0]
  connect_bd_net -net renamebuffer_0_query_line_rt [get_bd_pins renamebuffer_0/query_line_rt] [get_bd_pins rob_0/search_line_1]
  ...
  connect_bd_net -net reservestation_0_cdb [get_bd_pins reservestation_0/cdb] [get_bd_pins rob_0/cdb]
  connect_bd_net -net reservestation_0_lsu_din [get_bd_pins loadstore_functionun_0/din] [get_bd_pins reservestation_0/lsu_din]
  connect_bd_net -net rob_0_commit_bpfailed [get_bd_pins commit_bpfailed] [get_bd_pins rob_0/commit_bpfailed]
  ...
  connect_bd_net -net rob_0_commit_line [get_bd_pins loadstore_functionun_0/pnr] [get_bd_pins renamebuffer_0/commit_robitem] [get_bd_pins reservestation_0/commit_index] [get_bd_pins rob_0/commit_line]
  ...
  connect_bd_net -net rob_0_commit_store [get_bd_pins l1_cache_0/wvalid] [get_bd_pins loadstoreunit_0/store_queue_pop] [get_bd_pins rob_0/commit_store]
  ...
  connect_bd_net -net rob_0_do_commit [get_bd_pins do_commit] [get_bd_pins registers_0/commit] [get_bd_pins renamebuffer_0/do_commit] [get_bd_pins reservestation_0/do_commit] [get_bd_pins rob_0/do_commit]
  ...
  connect_bd_net -net rob_0_rob_next_item [get_bd_pins loadstoreunit_0/sqitem_index] [get_bd_pins renamebuffer_0/new_rob_item] [get_bd_pins reservestation_0/rob_free_item] [get_bd_pins rob_0/rob_next_item]
  connect_bd_net -net rob_0_rob_not_full [get_bd_pins dispatcher_0/rob_ready] [get_bd_pins rob_0/rob_not_full]
  connect_bd_net -net rob_0_search_ready_0 [get_bd_pins renamebuffer_0/query_ready_rs] [get_bd_pins rob_0/search_ready_0]
  connect_bd_net -net rob_0_search_ready_1 [get_bd_pins renamebuffer_0/query_ready_rt] [get_bd_pins rob_0/search_ready_1]
  connect_bd_net -net rob_0_search_result_0 [get_bd_pins renamebuffer_0/query_result_rs] [get_bd_pins rob_0/search_result_0]
  connect_bd_net -net rob_0_search_result_1 [get_bd_pins renamebuffer_0/query_result_rt] [get_bd_pins rob_0/search_result_1]
  connect_bd_net -net rob_0_start_reissue [get_bd_pins dispatcher_0/start_reissue] [get_bd_pins loadstoreunit_0/rst_reissue] [get_bd_pins renamebuffer_0/rst_startreissue] [get_bd_pins reservestation_0/rst_startreissue] [get_bd_pins rob_0/start_reissue]
  connect_bd_net -net rst_0_1 [get_bd_pins rst] [get_bd_pins l1_cache_0/rst] [get_bd_pins loadstore_functionun_0/rst] [get_bd_pins loadstoreunit_0/rst] [get_bd_pins registers_0/rst] [get_bd_pins renamebuffer_0/rst] [get_bd_pins reservestation_0/rst] [get_bd_pins rob_0/rst]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_0_1 [get_bd_pins CPUBackEnd/clk] [get_bd_pins CPUFrontEnd/clk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins thinpad_sram_0/s00_axi_aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins CPUBackEnd/m00_axi_aresetn] [get_bd_pins CPUFrontEnd/m00_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins thinpad_sram_0/s00_axi_aresetn]
  ...
  connect_bd_net -net rst_0_1 [get_bd_pins CPUBackEnd/rst] [get_bd_pins CPUFrontEnd/rst] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  ...
  create_bd_addr_seg -range 0x00002000 -offset 0xC0000000 [get_bd_addr_spaces CPUBackEnd/axi_simple_master_0/M00_AXI] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00800000 -offset 0x80000000 [get_bd_addr_spaces CPUBackEnd/axi_simple_master_0/M00_AXI] [get_bd_addr_segs thinpad_sram_0/S00_AXI/S00_AXI_mem] SEG_thinpad_sram_0_S00_AXI_mem
