...
# module references:
# dispatcher, l1_cache, loadstore_functionunit, loadstoreunit, registers, renamebuffer, reservestation, rob, branch_predictor, decoder, if_controller, if_insn_queue, if_memory_accessor, if_tlb_fetcher, jump_predictor, pc_counter
