...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clka, wea, addra, dina, douta, clkb, enb, web, addrb, dinb, 
  doutb)
/* synthesis syn_black_box black_box_pad_pin="clka,wea[0:0],addra[4:0],dina[53:0],douta[53:0],clkb,enb,web[0:0],addrb[4:0],dinb[53:0],doutb[53:0]" */;
  input clka;
  input [0:0]wea;
  input [4:0]addra;
  input [53:0]dina;
